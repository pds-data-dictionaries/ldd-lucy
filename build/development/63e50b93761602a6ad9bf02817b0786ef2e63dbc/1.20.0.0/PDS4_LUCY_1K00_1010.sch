<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:lucy  Version:1.0.1.0 - Sat Dec 27 00:26:37 UTC 2025 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="lucy:LRalph_Instrument_Common_Parameters/lucy:playback_header_type">
      <sch:assert test=". = ('LEISA_CDS', 'LEISA_NONCDS', 'LEISA_SUPER', 'MVIC', 'OTHER')">
        <title>lucy:LRalph_Instrument_Common_Parameters/lucy:playback_header_type/lucy:playback_header_type</title>
        The attribute lucy:LRalph_Instrument_Common_Parameters/lucy:playback_header_type must be equal to one of the following values 'LEISA_CDS', 'LEISA_NONCDS', 'LEISA_SUPER', 'MVIC', 'OTHER'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="lucy:Lucy_Observation_Planning/lucy:mission_segment">
      <sch:assert test=". = ('3I/ATLAS', 'CRUISE 1', 'CRUISE 2', 'CRUISE 3', 'DINKINESH', 'DONALDJOHANSON', 'EGA 1', 'EGA 2')">
        <title>lucy:Lucy_Observation_Planning/lucy:mission_segment/lucy:mission_segment</title>
        The attribute lucy:Lucy_Observation_Planning/lucy:mission_segment must be equal to one of the following values '3I/ATLAS', 'CRUISE 1', 'CRUISE 2', 'CRUISE 3', 'DINKINESH', 'DONALDJOHANSON', 'EGA 1', 'EGA 2'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
